...
find_package(catkin REQUIRED COMPONENTS euslisp assimp_devel)
...
include_directories(/usr/include /usr/X11R6/include ${euslisp_INCLUDE_DIRS} ${assimp_devel_INCLUDE_DIRS})
add_library(eus_assimp src/eus_assimp.cpp)

target_link_libraries(eus_assimp ${assimp_devel_LIBRARIES})
...
catkin_package(
    DEPENDS
    CATKIN_DEPENDS assimp_devel # euslisp TODO
