...
macro(get_urdf2sem _urdf2sem_exe)
  find_package(knowrob_semantic_maps REQUIRED)
  if(EXISTS ${knowrob_semantic_maps_SOURCE_DIR}/scripts/URDF2SRDL)
    set(${_urdf2sem_exe} ${knowrob_semantic_maps_SOURCE_DIR}/scripts/urdf_to_sem)
  elseif (EXISTS ${knowrob_semantic_maps_SOURCE_PREFIX}/scripts/urdf_to_sem)
    set(${_urdf2sem_exe} ${knowrob_semantic_maps_SOURCE_PREFIX}/scripts/urdf_to_sem)
  elseif (EXISTS ${knowrob_semantic_maps_PREFIX}/share/knowrob_semantic_maps/scripts/urdf_to_sem)
    set(${_urdf2sem_exe} ${knowrob_semantic_maps_PREFIX}/share/knowrob_semantic_maps/scripts/urdf_to_sem)
  else()
