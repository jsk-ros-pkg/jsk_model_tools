...
def convert_all_eusmodel ():
    ...
    for eusmodel_file_path in eusmodel_file_path_list.split('\n'):
        ...
        if regexp_search_res:
            ...
            os.system('rosrun roseus roseus "(progn (load \\"package://eusgazebo/euslisp/eusgazebo-util.l\\") (progn (load \\"package://euslisp/jskeus/eus/models/%s\\") (irteus2urdf-for-gazebo (%s) :urdf-dir \\"%s\\") (exit))"' % (eusmodel_file_name, eusmodel_function_name, urdfmodel_dir_path))
